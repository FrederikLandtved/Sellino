...
// Services for Order
builder.Services.AddDbContext<OrderDbContext>(options => options.UseSqlServer(connectionString, assembly => assembly.MigrationsAssembly(typeof(OrderDbContext).Assembly.FullName)));
...
{
    builder.WithOrigins("https://lively-plant-06f32b803.4.azurestaticapps.net", "http://localhost:4200", "https://yellow-bay-0e3cc2303.4.azurestaticapps.net", "http://localhost:50440")
           .AllowAnyMethod()
           .AllowAnyHeader();
}));
