...
export class ThemeService {
  ...
  UpdateColorTheme(companyHexColor: string, textOnCompanyHexColor: string, darkCompanyColor: string, secondaryCompanyHexColor: string, textOnSecondaryCompanyHexColor: string) {
